...
(function($){
	...
	if ($.sc_cms.lang_msg === undefined) $.sc_cms.lang_msg = {}
	
	$.sc_cms.require = (function(url) {
	...
	$.sc_cms.lang = (function(lang, lang_msg) {

		lang.load = function(){
			
			load_lang = $('html').attr('lang') || 'en';
   			
			urlscript = urlbase;
			
			try {
			
				urlscript += '/lang/lang_js/' + load_lang + '.js';
				
				$.sc_cms.require(urlscript);
		...
		lang.get = function(search) {
			
			if (!search) return;
			
			var result = $.sc_cms.lang_msg
	    ...
	    if (lang.loader === undefined) {
			lang.load();
		}
		
		return lang;
		
})($.sc_cms.lang || {}, $.sc_cms.lang_msg);	
	
	
	
	$.sc_cms.ajaxErrorMessage	= function(message, error) {
		...
		try {
			...
			if(response['ERROR_MESSAGE']){
				...
				if(callback){
					...
					var func = new Function('e', response['CALLBACK']);
					
					$.sc_cms.alert(response['ERROR_MESSAGE'], func);
					
				}else{
						
					$.sc_cms.alert(response['ERROR_MESSAGE'], '');
	...
	*/
	if (window.swal) {
		...
		$.sc_cms.alert = function alert(message, callback) {
			...
			swal({
				...
				title: message,
				showCancelButton: false,
				confirmButtonText: $.sc_cms.lang.get('_OK'),
				cancelButtonText: $.sc_cms.lang.get('_CANCEL'),
				confirmButtonClass: 'btn-primary',
		...
		$.sc_cms.confirm = function confirm(message, callback) {
